...
void FOnJoyColorChangedEvent_DelegateWrapper(const FMulticastScriptDelegate& OnJoyColorChangedEvent, FLinearColor const& NewColor)
{
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SeniorProject_HideAndSeek_Plugins_VictoryBPLibrary_Source_VictoryBPLibrary_Public_RamaColorPicker_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SeniorProject_HideAndSeek_Plugins_VictoryBPLibrary_Source_VictoryBPLibrary_Public_RamaColorPicker_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SeniorProject_HideAndSeek_Plugins_VictoryBPLibrary_Source_VictoryBPLibrary_Public_RamaColorPicker_h_520284843(TEXT("/Script/VictoryBPLibrary"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SeniorProject_HideAndSeek_Plugins_VictoryBPLibrary_Source_VictoryBPLibrary_Public_RamaColorPicker_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SeniorProject_HideAndSeek_Plugins_VictoryBPLibrary_Source_VictoryBPLibrary_Public_RamaColorPicker_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
