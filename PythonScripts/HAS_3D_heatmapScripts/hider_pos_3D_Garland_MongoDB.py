...
for document in garlandCollection.find():
    hider_Garland_x.append(document['xHider'])
    hider_Garland_y.append(document['yHider'])
    
skipped_hider_Garland_x = [x[20:] for x in hider_Garland_x]
skipped_hider_Garland_y = [y[20:] for y in hider_Garland_y]

# combine separated csv into one giant list for x and y
combine_x = [item for sublist in skipped_hider_Garland_x for item in sublist]
combine_y = [item for sublist in skipped_hider_Garland_y for item in sublist]
