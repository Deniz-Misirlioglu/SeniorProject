...
for document in valleysCollection.find():
    seeker_Valleys_x.append(document['xSeeker'])
    seeker_Valleys_y.append(document['ySeeker'])

skipped_seeker_Valleys_x = [x[52:] for x in seeker_Valleys_x]
skipped_seeker_Valleys_y = [y[52:] for y in seeker_Valleys_y]

# combine separated csv into one giant list for x and y
combine_x = [item for sublist in skipped_seeker_Valleys_x for item in sublist]
combine_y = [item for sublist in skipped_seeker_Valleys_y for item in sublist]
